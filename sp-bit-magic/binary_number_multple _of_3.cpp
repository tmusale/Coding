...
Else prints 0. The given number can be big upto 2^100. It is recommended to finish 
the task using one traversal of input binary string.
...
Hint :- Just count the even places where the bit is set and odd places where the bit is set.
